...
Routes:
    ...
    /number_template/<n>: display a HTML page only if n is an integer with H1 tag: “Number: n” inside the BODY tag
"""
...
def number_template(n):
    """Display an HTML page only if n is an integer with H1 tag: “Number: n” inside the BODY tag."""
